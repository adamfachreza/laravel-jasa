...
use App\Http\Requests\Dashboard\Profile\UpdateProfileUserRequest;
...
class ProfileController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateProfileUserRequest $request_profile, UpdateDetailUserRequest $request_detail_user)
    {
        ...
        Alert::success('Update has been success');
        return back();
    }
